    ...
    <table>
        <tr>
            <td>
                ...
                <span class="value">{{ number_format((float) $policy->lifeDetails->sum_assured, 2) }}</span>
            </td>
            <td>
                <span class="label">Term</span>
                <span class="value">{{ $policy->lifeDetails->term_years }} years</span>
            </td>
        </tr>
        <tr>
            <td>
                <span class="label">Smoker</span>
                <span class="value">{{ $policy->lifeDetails->smoker ? 'Yes' : 'No' }}</span>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <span class="label">Beneficiaries</span>
                <span class="value">{{ $policy->lifeDetails->beneficiaries }}</span>
            </td>
        </tr>
    </table>
</body>
