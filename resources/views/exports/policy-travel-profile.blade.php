    ...
    <table>
        <tr>
            <td>
                ...
                <span class="value">{{ $policy->travelDetails->destination }}</span>
            </td>
            <td>
        ...
        <tr>
            <td>
                ...
                <span class="value">{{ $policy->travelDetails->trip_start_date->format('M j, Y') }}</span>
            </td>
            <td>
                <span class="label">Trip end date</span>
                <span class="value">{{ $policy->travelDetails->trip_end_date->format('M j, Y') }}</span>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <span class="label">Travelers</span>
                <span class="value">{{ $policy->travelDetails->travelers }}</span>
            </td>
        </tr>
    </table>
</body>
