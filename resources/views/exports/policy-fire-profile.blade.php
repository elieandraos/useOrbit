    ...
    <table>
        <tr>
            <td>
                ...
                <span class="value">{{ $policy->fireDetails->property_type }}</span>
            </td>
            <td>
                <span class="label">Floor area</span>
                <span class="value">{{ $policy->fireDetails->floor_area }} m&sup2;</span>
            </td>
        </tr>
        <tr>
            <td>
                <span class="label">Year built</span>
                <span class="value">{{ $policy->fireDetails->year_built ?? '—' }}</span>
            </td>
            <td>
        ...
        <tr>
            <td>
                ...
                <span class="value">{{ $policy->fireDetails->street }}{{ $policy->fireDetails->building_floor ? ', '.$policy->fireDetails->building_floor : '' }}</span>
            </td>
            <td>
                <span class="label">City</span>
                <span class="value">{{ $policy->fireDetails->city }}</span>
            </td>
        </tr>
        <tr>
            <td>
                <span class="label">State</span>
                <span class="value">{{ $policy->fireDetails->state?->name ?? '—' }}</span>
            </td>
            <td>
                <span class="label">Country</span>
                <span class="value">{{ $policy->fireDetails->country?->name ?? '—' }}</span>
            </td>
        </tr>
    </table>
</body>
