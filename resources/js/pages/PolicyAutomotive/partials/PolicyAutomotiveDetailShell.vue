...
import { show as policiesAutomotiveShow } from '@/routes/policies/automotive';
...
import PolicyAutomotiveShowHeader from './PolicyAutomotiveShowHeader.vue';
...
<template>
    ...
    <div class="flex flex-1 flex-col">
        <PolicyAutomotiveShowHeader :policy="policy" />
        ...
        >
            <Tabs class="min-w-max">
                <Tab :href="policiesAutomotiveShow(policy.slug).url"
                    >Overview</Tab
                >
                <button
                    type="button"
