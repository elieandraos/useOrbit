...
<template>
    ...
    <h1 class="text-2xl font-semibold mb-10">Separator</h1>
    ...
    <div class="flex flex-col gap-10">
        <div v-for="section in sections" :id="section.id" :key="section.id" class="flex flex-col gap-3">
            ...
            >
                <div v-if="section.id === 'horizontal'" class="flex flex-col gap-4">
                    <span class="text-sm text-secondary">Above</span>
                    <Separator />
                    <span class="text-sm text-secondary">Below</span>
                </div>

                <div v-else-if="section.id === 'vertical'" class="flex items-center gap-4 h-8">
