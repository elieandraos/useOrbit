...
<template>
    ...
    <h1 class="text-2xl font-semibold mb-10">Label</h1>
    ...
    <div class="flex flex-col gap-10">
        <div v-for="section in sections" :id="section.id" :key="section.id" class="flex flex-col gap-3">
            ...
            >
                <div v-if="section.id === 'default'" class="flex flex-col gap-1.5 max-w-sm">
                    <Label for="email">Email address</Label>
                    <Input id="email" placeholder="you@example.com" />
                </div>

                <div v-else-if="section.id === 'required'" class="flex flex-col gap-1.5 max-w-sm">
