...
<template>
    ...
    <h1 class="text-2xl font-semibold mb-10">Button</h1>
    ...
    <div class="flex flex-col gap-10">
        <div v-for="section in sections" :id="section.id" :key="section.id" class="flex flex-col gap-3">
            ...
            >
                <div v-if="section.id === 'variants'" class="flex flex-wrap gap-3">
                ...
                <div v-else-if="section.id === 'sizes'" class="flex flex-wrap items-center gap-3">
                    <Button size="sm">Small</Button>
                    <Button size="md">Medium</Button>
                    <Button size="lg">Large</Button>
                </div>

                <div v-else-if="section.id === 'leading-slot'" class="flex flex-wrap gap-3">
                    <Button>
                ...
                <div v-else-if="section.id === 'trailing-slot'" class="flex flex-wrap gap-3">
                    <Button>
                        Continue
                ...
                <div v-else-if="section.id === 'disabled'" class="flex flex-wrap gap-3">
