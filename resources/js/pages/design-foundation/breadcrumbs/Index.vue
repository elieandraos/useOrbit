...
<template>
    ...
    <h1 class="text-2xl font-semibold mb-10">Breadcrumbs</h1>
            ...
            >
                ...
                <div v-else-if="section.id === 'define-options'">
                    ...
                    <p class="mt-4 text-xs text-secondary">
                        Use <code class="font-mono">defineOptions</code> when breadcrumb titles and hrefs are known at
                        compile time (no runtime props needed).
                    </p>
                </div>
                ...
                <div v-else-if="section.id === 'set-layout-props'">
                    ...
                    <p class="mt-4 text-xs text-secondary">
                        Use <code class="font-mono">setLayoutProps</code> when breadcrumbs depend on
                        <code class="font-mono">defineProps</code> values (e.g. a slug or name from the server).
                    </p>
                </div>
            </div>
