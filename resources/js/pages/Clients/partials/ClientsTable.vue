...
const fillerRowCount = computed(() =>
    Math.max(0, props.clients.meta.per_page - props.clients.data.length),
);
        ...
        <table class="w-full table-fixed border-collapse">
            ...
            <tbody>
                ...
                >
                    ...
                    <td class="truncate px-4 py-3 text-[13px] text-secondary">
                        {{ client.email }}
                    </td>
                ...
                <tr
                    ...
                    aria-hidden="true"
                >
                    <td class="min-w-0 px-4 py-3" colspan="5">
                        <div
                            class="flex min-w-0 items-center gap-2.5 opacity-0"
                        >
                            <Avatar name="x" :size="30" />
                            <div class="min-w-0">
                                <div class="text-[13.5px] font-medium">
                                    &nbsp;
                                </div>
                                <div class="mt-0.5 font-mono text-[11.5px]">
                                    &nbsp;
                                </div>
                            </div>
                        </div>
