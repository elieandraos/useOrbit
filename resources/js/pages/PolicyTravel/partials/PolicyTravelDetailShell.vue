...
import { show as policiesTravelShow } from '@/routes/policies/travel';
import type { PolicyResource } from '@/types/policy';
import PolicyTravelShowHeader from './PolicyTravelShowHeader.vue';
...
<template>
    ...
    <div class="flex flex-1 flex-col">
        <PolicyTravelShowHeader :policy="policy" />
        ...
        >
            <Tabs class="min-w-max">
                <Tab :href="policiesTravelShow(policy.slug).url">Overview</Tab>
                <button
                    type="button"
