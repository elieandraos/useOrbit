...
import { show as policiesLifeShow } from '@/routes/policies/life';
import { index as policiesNotesIndex } from '@/routes/policies/notes';
import type { PolicyResource } from '@/types/policy';
import PolicyLifeShowHeader from './PolicyLifeShowHeader.vue';
...
<template>
    ...
    <div class="flex flex-1 flex-col">
        <PolicyLifeShowHeader :policy="policy" />
        ...
        >
            <Tabs class="min-w-max">
                <Tab :href="policiesLifeShow(policy.slug).url">Overview</Tab>
                <button
                    type="button"
