...
import { show as policiesFireShow } from '@/routes/policies/fire';
import { index as policiesNotesIndex } from '@/routes/policies/notes';
import type { PolicyResource } from '@/types/policy';
import PolicyFireShowHeader from './PolicyFireShowHeader.vue';
...
<template>
    ...
    <div class="flex flex-1 flex-col">
        <PolicyFireShowHeader :policy="policy" />
        ...
        >
            <Tabs class="min-w-max">
                <Tab :href="policiesFireShow(policy.slug).url">Overview</Tab>
                <button
                    type="button"
