...
test('member can update and delete a branch belonging to their organization', function () {
    ...
    expect($member->can('update', $branch))->toBeTrue()
        ->and($member->can('delete', $branch))->toBeTrue();
});

test('user cannot update or delete a branch belonging to a different organization', function () {
    $organization = Organization::factory()->create();
