...
final class ResourceUnarchivedNotification extends EnvelopeNotification
{
    public const string ACTION = 'resource.unarchived';
    ...
    {
        return __(':actor unarchived :kind :name.', [
